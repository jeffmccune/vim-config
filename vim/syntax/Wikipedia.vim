...
" wiki formatting
"syn region wikiItalic start="\([^']\|\_^\)''[^']"hs=s+1 end="[^']''\([^']\|\_$\)"he=e-1 skip=".*" contains=wikiLink,wikiItalicBold
"syn region wikiBold start="\([^']\|\_^\)'''[^']" end="[^']'''\([^']\|\_$\)" skip=".*" contains=wikiLink,wikiBoldItalic

"syn region wikiBoldItalic contained start="\([^']\|\_^\)''[^']" end="[^']''\([^']\|\_$\)" skip=".*" contains=wikiLink
"syn region wikiItalicBold contained start="\([^']\|\_^\)'''[^']" end="[^']'''\([^']\|\_$\)" skip=".*" contains=wikiLink

"syn region wikiBoldAndItalic start="'''''" end="'''''" skip=".*" contains=wikiLink
...
syn region wikiH1 start="^=" 		end="=" 	skip=".*" oneline contains=@Spell,wikiLink
syn region wikiH2 start="^==" 		end="==" 	skip=".*" oneline contains=@Spell,wikiLink
syn region wikiH3 start="^===" 		end="===" 	skip=".*" oneline contains=@Spell,wikiLink
syn region wikiH4 start="^====" 	end="====" 	skip=".*" oneline contains=@Spell,wikiLink
syn region wikiH5 start="^=====" 	end="=====" 	skip=".*" oneline contains=@Spell,wikiLink
syn region wikiH6 start="^======" 	end="======" 	skip=".*" oneline contains=@Spell,wikiLink
syn region wikiLink start="\[\[" end="\]\]\(s\|'s\|es\|ing\|\)" skip=".*" oneline contains=wikiLink
syn region wikiLink start="\[http:" end="\]" skip=".*" oneline
syn region wikiLink start="\[https:" end="\]" skip=".*" oneline
syn region wikiLink start="\[ftp:" end="\]" skip=".*" oneline
syn region wikiLink start="\[gopher:" end="\]" skip=".*" oneline
syn region wikiLink start="\[news:" end="\]" skip=".*" oneline
syn region wikiLink start="\[mailto:" end="\]" skip=".*" oneline
syn region wikiTemplate start="{{" end="}}" skip=".*" 
...
syntax region wikiTeX matchgroup=htmlTag start="<math>" end="</math>" skip=".*" contains=@texMathZoneGroup 
syntax region wikiRef matchgroup=htmlTag start="<ref>" end="</ref>" skip=".*"
